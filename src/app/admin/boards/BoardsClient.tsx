      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
        ...
        <form onSubmit={handleCreate} className="flex items-end gap-3">
          ...
          <button
            type="submit"
            disabled={isPending}
            className="h-9 px-4 rounded-lg bg-blue-600 text-white text-sm font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 shrink-0 inline-flex items-center gap-1"
          >
